...
export const BUBBLE_VERTICAL_OFFSET_PX = 28
...
export const SPEECH_BUBBLE_DURATION_SEC = 5.0
export const SPEECH_BUBBLE_FADE_SEC = 0.5
export const SPEECH_BUBBLE_MAX_CHARS = 30
